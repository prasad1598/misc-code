...
resource "azurerm_linux_virtual_machine" "vm" {
  ...
  # delete_data_disks_on_termination = true
    ...
    source_image_id_id = "/subscriptions/aa32da49-0603-4855-b55b-bfd4bcf7b16f/resourceGroups/project_rg/providers/Microsoft.Compute/images/test-devops-practice"
...
resource "null_resource" "vault" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "ansible-pull -i localhost, -U https://github.com/prasad1598/misc-code.git toolsetup/tool_setup.yml -e tool_name=$(var.name)"
    ]
  }
}
